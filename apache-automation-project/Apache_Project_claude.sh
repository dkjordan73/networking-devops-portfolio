...
sudo tee "$WEB_ROOT/portfolio-styles.css" >/dev/null <<'STYLESHEET'
:root {
  --primary-blue: #0891b2;
...
sudo tee "$WEB_ROOT/index.html" >/dev/null <<'HOMEPAGE'
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
sudo tee "$WEB_ROOT/about.html" >/dev/null <<'ABOUTPAGE'
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
sudo tee "$WEB_ROOT/projects.html" >/dev/null <<'PROJECTSPAGE'
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <main class="container">
    ...
    <div class="content-card">
      <h3 class="section-header">☁️ Cloud Infrastructure Project</h3>
    ...
    <div class="content-card highlight-box">
      <h2 class="section-header">📊 Server Management Commands</h2>
...
# Display completion message with server IP
...
echo "=================================="
echo
echo "Your DevOps Portfolio is now live!"
echo
echo "Access your site at:"
echo "  Home:     http://$SERVER_IP/"
echo "  About:    http://$SERVER_IP/about.html"
echo "  Projects: http://$SERVER_IP/projects.html"
echo
echo "=================================="
